...
public class PersonassController {
    private PersonassService primeraImplementacion;
    
    public PersonassController(@Qualifier("primeraImplementacionYYY") PersonassService primeraImplementacion) {
    ...
    public Personass sendGreetingDelete() {
        return primeraImplementacion.calcula("algo", "pedregal", "gus1DELETE", "arellanbo", "sandoval");
    } 
    @PostMapping(
            value= "/pregunta2", 
    ...
    @PostMapping(
            value= "/guardaPersona", 
            produces = "application/json; charset=utf-8")
    public Personass sendGreetings3(@RequestBody Personass p) {
        return p;
    }
    ...
    @GetMapping(
            ...
            produces = "application/json; charset=utf-8")
    public Personass testDiagonalesA(
    ...
    @GetMapping(
            ...
            produces = "application/json; charset=utf-8")
    public Personass testDiagonalesB(
            @RequestHeader("User-Agent") String ua,
            @RequestHeader String colonia,
            @PathVariable String variable1, 
            @PathVariable String variable2) {
    ...
    @GetMapping(
            value= "/personas", 
            produces = "application/json; charset=utf-8")
    public List<Personass> personas() {
